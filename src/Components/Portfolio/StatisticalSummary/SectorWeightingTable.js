...
export default function SectorWeightingTable({benchmarkSectorWeighting,portfolioWeighting}) {
  ...
  const rows = [
    createData(sector[0],weightingObj[sector[0]]?weightingObj[sector[0]]:0,weightPercentage[0]), //*real estate
    createData(sector[1],weightingObj[sector[1]]?weightingObj[sector[1]]:0,weightPercentage[1]), //* consumer cyclica
    createData(sector[2],weightingObj[sector[2]]?weightingObj[sector[2]]:0,weightPercentage[2]), //* basic mateirals
    createData(sector[3],weightingObj[sector[3]]?weightingObj[sector[3]]:0,weightPercentage[3]), //* consumer defensive
    createData(sector[4],weightingObj[sector[4]]?weightingObj[sector[4]]:0,weightPercentage[4]), //* technology
    createData(sector[5],weightingObj[sector[5]]?weightingObj[sector[5]]:0,weightPercentage[5]), //* comunication services
    createData(sector[6],weightingObj[sector[6]]?weightingObj[sector[6]]:0,weightPercentage[6]), //* financail services
    createData(sector[7],weightingObj[sector[7]]?weightingObj[sector[7]]:0,weightPercentage[7]), //* utilites
    createData(sector[8],weightingObj[sector[8]]?weightingObj[sector[8]]:0,weightPercentage[8]), //* indiustrials
    createData(sector[9],weightingObj[sector[9]]?weightingObj[sector[9]]:0,weightPercentage[9]), //* energy
    createData(sector[10],weightingObj[sector[10]]?weightingObj[sector[10]]:0,weightPercentage[10]), //* healthcare
  ];
  return (
