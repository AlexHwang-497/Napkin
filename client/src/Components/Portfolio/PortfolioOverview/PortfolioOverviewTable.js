...
function createReturnsTableData(year, jan,feb,mar,apr,may,jun,jul,aug,sep,oct,nov,dec) {
  ...
  // ];
  export default function PortfolioOverviewTable({image, assets, totalPortfolioValue}) {
    let Finance = require('financejs');
    let finance = new Finance();
    console.log('this is the totalPortfolioValue',totalPortfolioValue)
    // console.log('this is the totalPortfolioValue',totalPortfolioValue[0])
    // console.log('annualized return',finance.CAGR(totalPortfolioValue[0][0],totalPortfolioValue[0][totalPortfolioValue.length],totalPortfolio[0][0].length/12))
    // console.log('annualized return',finance.CAGR(totalPortfolioValue[0][0],totalPortfolioValue[0][totalPortfolioValue.length-1],12/12))
